     ...
     private void setUpGame()
   {
     ...
     private void startPlaying ()
     {
         while (!startups.isEmpty())
         {
             ...
             checkUserGuess(userGuess); //checks userguess.
         }   
     ...
     {
         numOfGuesses++; //increment guesses. 
         String result = "miss"; //assumes miss.
    ...
    private ArrayList<Startup> startups = new ArrayList <Startup>(); //creates arraylist for startups
